<template>
    <!-- template no cambia el html, sirve para agrupar condicionales -->
  <template v-if="entry">
    <div class="entry-title d-flex justify-content-between p-2">
      ...
      <div>
        <input v-show="false" ref="imageSelector" type="file" @change="onSelectedImage"/>
        <button v-if="entry.id" @click="onDeleteEntry" class="btn btn-danger mx-2">
          Borrar <i class="fa fa-trash-alt"></i>
        </button>
        <button @click="inputFileTrigger" class="btn btn-primary">
    ...
    <!-- <img
    src="https://cdn0.matrimonios.cl/vendor/4636/3_2/960/jpg/ideal-para-tu-evento.jpeg"
    alt="image"
    class="img-thumbnail"
  /> -->
  <img
...
export default {
  ...
  methods: {
    ...
    onSelectedImage( event ){
      ...
      if(!file) {
        this.file = null
        this.localImage = null // cancel select
        return }
      this.file = file
